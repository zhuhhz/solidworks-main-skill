...
The third-party `wzyn20051216/solidworks-automation-skill` is an upstream automation skill. It is not part of `solidworks-main-skill` and must not be represented as owned source.
